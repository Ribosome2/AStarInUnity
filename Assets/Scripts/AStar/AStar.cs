...
public class AStar
{
    ...
    private static void FillPath(Node node, ArrayList targetList)
    {
       targetList.Clear();
        while (node != null)
        {
    ...
    public static IEnumerator FindPath(Node start, Node goal,ArrayList arrayList)
    {
        //Start Finding the path
        openList = new PriorityQueue();
        openList.Push(start);
